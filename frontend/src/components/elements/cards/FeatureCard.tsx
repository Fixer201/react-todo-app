...
const FeatureCard = ({ imagePath, title, description }: FeatureCardProps) => {
    return (
        <article className="flex h-full flex-col items-center group-hover:scale-90 hover:scale-110 transition-normal duration-300 text-center p-6 bg-secondary rounded-lg glow-secondary-on-hover">
            {/* Feature Image */}
            <img
                src={imagePath}
                alt={title}
